...
class ModifyUnsafeConditionState extends Equatable {
  ...
  toUnsafeCondition() => SearchUnsafeAction(
  ...
  ModifyUnsafeConditionState copyWith({
    ...
    return ModifyUnsafeConditionState(
